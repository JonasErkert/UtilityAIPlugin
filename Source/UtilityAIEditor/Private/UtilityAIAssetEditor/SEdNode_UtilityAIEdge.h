...
class SEdNode_UtilityAIEdge : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SEdNode_UtilityAIEdge){}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UEdNode_UtilityAIEdge* InNode);
